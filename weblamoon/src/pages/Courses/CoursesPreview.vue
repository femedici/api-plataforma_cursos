<template>
    <div class=" isolate overflow-hidden bg-zinc-200 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        <div :style="{ 'filter': showPayment ? 'blur(8px)' : 'none' }">
        ...
        <pop-payment v-if="showPayment" @close="closePayment" @finish="handlePayment"></pop-payment>
    </div>
</template>
...
import PopPayment from '@/components/PopPayment.vue';
