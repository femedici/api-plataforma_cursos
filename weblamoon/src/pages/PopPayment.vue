    ...
    <div v-if="picked === 'Cartao'">
      <form class="bg-gray w-full max-w-3xl mx-auto px-4 lg:px-6 py-8 shadow-md rounded-md flex flex-col lg:flex-row">
        <div class="w-full lg:w-1/2 lg:pr-8 lg:border-r-2 lg:border-slate-300">
          <div class="mb-4">
            <label class="text-white font-bold text-sm mb-2 block">Numero do Cartão:</label>
            <input type="text" onclick="hideBackCard()"
              ...
              maxlength="19" placeholder="XXXX XXXX XXXX XXXX" value="1232 1312 3123 1231">
          </div>
          <div class="flex gap-x-2 mb-4">
            <div class="block">
              <label class="text-white font-bold text-sm mb-2 block">Validade:</label>
              <input type="text" onclick="hideBackCard()"
                class="flex h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 undefined"
                maxlength="5" placeholder="MM/YY" value="11/29">
            </div>
            <div class="block">
              <label class="text-white font-bold text-sm mb-2 block">CVV:</label>
              <input type="text"
                class="flex h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 undefined"
                maxlength="3" placeholder="123" value="111">
            </div>
          </div>
          <div class="mb-4">
            ...
            <input type="text" onclick="hideBackCard()"
              class="flex h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 undefined"
              placeholder="Fulano" value="Fulano">
          </div>
        </div>
            ...
            <div id="creditCard" class="relative crediCard cursor-pointer transition-transform duration-500 "
              ...
              <div class="w-full h-56 m-auto rounded-xl text-white shadow-2xl absolute"
                ...
                <div class="w-full px-8 absolute top-8">
                  ...
                  <div class="pt-1">
                    <p class="font-light">Número do Cartão</p>
                  ...
                  <div class="pt-6 flex justify-between">
                    ...
                    <div>
                      <p class="font-light">Expira</p>
                      <p class="font-medium tracking-wider h-6 w-14">11/29</p>
                    </div>
                  </div>
                </div>
              </div>
